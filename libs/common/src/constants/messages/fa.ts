export const fa = {
    ...
    VALIDATION: {
        AUTH: {
            ...
            PASSWORD_MAXLENGTH: 'رمز عبور نمی‌تواند بیش از ۳۲ کاراکتر باشد.',
            PASSWORD_COMPLEXITY:
        ...
        USER: {
            ...
            FIRSTNAME_MAXLENGTH: 'نام نمی‌تواند بیش از ۳۰ کاراکتر باشد.',
            LASTNAME_STRING: 'نام خانوادگی باید از نوع رشته باشد.',
            LASTNAME_MAXLENGTH: 'نام خانوادگی نمی‌تواند بیش از ۳۰ کاراکتر باشد.',
