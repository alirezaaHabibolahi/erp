...
2.2002.3 = SALES_PROFORMA.UPDATE
2.2002.4 = SALES_PROFORMA.SOFT_DELETE
2.2002.5 = SALES_PROFORMA.HARD_DELETE
2.2002.11 = SALES_PROFORMA.SUBMIT
2.2002.6 = SALES_PROFORMA.APPROVE
2.2002.7 = SALES_PROFORMA.REJECT
2.2002.8 = SALES_PROFORMA.CANCEL
SALES_PROFORMA.CONVERT_TO_INVOICE
2.2002.10 = SALES_PROFORMA.EXPORT
2.2002.9 = SALES_PROFORMA.PRINT
```
...
2.2001.4 = SALES_INVOICE.SOFT_DELETE
2.2001.5 = SALES_INVOICE.HARD_DELETE
2.2001.6 = SALES_INVOICE.APPROVE
2.2001.8 = SALES_INVOICE.CANCEL
SALES_INVOICE.VOID
SALES_INVOICE.SEND_TO_TAX
2.2001.10 = SALES_INVOICE.EXPORT
2.2001.9 = SALES_INVOICE.PRINT
```
...
```text
permission: 2.2001.1 = SALES_INVOICE.READ
scope: OWN
```
...
```text
permission: 2.2001.6 = SALES_INVOICE.APPROVE
scope: BRANCH
condition:
  maxAmount: 500000000
```
...
```text
permission: 2.2001.5 = SALES_INVOICE.HARD_DELETE
scope: ALL
```
...
request
  -> validate customer
  -> check 2.2002.2 = SALES_PROFORMA.CREATE
  -> validate items
  -> calculate totals
  -> generate number
...
```text
request
  -> check 2.2002.6 = SALES_PROFORMA.APPROVE
  -> load pre_invoice
